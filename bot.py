...
OIL_QUESTIONS = [
    ...
    {"q": "Какое масло лучше для современного турбомотора?",
     ...
     "correct": 3,
     "explanation": "Синтетика имеет лучшую защиту для современных моторов."}
]
